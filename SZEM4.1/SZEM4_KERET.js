...
function vercheck(){try{
	if (typeof(CVERZIO)=="undefined") {naplo("Globál","Verzióellenõrzés nem lehetséges. <a href='http://cncdani2.000webhostapp.com/!Files/SZEM4/SZEM4_VER.js' target='_BLANK'>Kattints ide</a> hogy megnézd mi a legfrisebb változat. A tiéd: "+VERZIO); return;}
...
function pic(file){
	return "http://cncdani2.000webhostapp.com/!Files/SZEM4/"+file;
}
...
function playSound(hang){try{
	...
	var play="http://cncdani2.000webhostapp.com/!Files/SZEM4/"+hang+".wav";
