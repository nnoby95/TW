...
var VILL1ST="";
var ALTBOT=true;;
var VERZIO="4.560606"; /* (4.)+(kieg.-ek száma)+(alverz.(dátum[ÉHHNN]))*/
...
function vercheck(){try{
	if (typeof(CVERZIO)=="undefined") {naplo("Globál","Verzióellenõrzés nem lehetséges. <a href='http://cncdani2.freeiz.com/SZEM4/SZEM4_VER.js' target='_BLANK'>Kattints ide</a> hogy megnézd mi a legfrisebb változat. A tiéd: "+VERZIO); return;}
